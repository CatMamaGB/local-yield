...
export function ListingRow({ listing }: ListingRowProps) {
  ...
  return (
    <tr className="border-b border-brand/10 transition hover:bg-brand-light/50">
      <td className="py-4 pr-4">
        <Link href={shopHref} className="group flex items-center gap-3">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-brand-light text-2xl">
          ...
          <div>
            ...
            {listing.producerName && (
              <span className="ml-2 text-sm text-brand/70">
