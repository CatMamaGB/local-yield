...
import { getUserCapabilities } from "./authz/client";
...
/** Whether we're in an "app" area (dashboard or admin) — Navbar shows minimal: logo + Account (Switch mode inside when isMultiMode) only. Strict: exact path or prefix with slash. */
